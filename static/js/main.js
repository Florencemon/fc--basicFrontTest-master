            ...
            <div class=" "  >
                <div class="card"  data-id="${ i.id }" >
                    <div class="card-body">
                        ...
                        <p class="card-text">Total:  <span class="total"  ><b>${ i.total }<b></span></p>
                        <div class="action">
...
function callEdit(id){
    try{
        //apiGET( `products/${id}`)
        let name = document.querySelector("[data-id='"+id+"']").getElementsByClassName("name")[0].textContent
        let total = document.querySelector("[data-id='"+id+"']").getElementsByClassName("total")[0].textContent
        ...
        modalEdit.show();
        formEdit.querySelector("#name").value = name;
        formEdit.querySelector("#total").value = total;
        formEdit.querySelector("#id").value = id;
